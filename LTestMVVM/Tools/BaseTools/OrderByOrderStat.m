...
#import "OrderByOrderStat.h"

@implementation OrderByOrderStat
...
//        formatter.dateFormat = @"yyyy年MM月dd日";
    ...
    return [array sortedArrayUsingComparator:^NSComparisonResult(id  _Nonnull obj1, id  _Nonnull obj2) {
        NSString *date1 = [obj1 valueForKey:@"actDate"];
        NSString *date2 = [obj2 valueForKey:@"actDate"];
...
//        } else if ([d1 compare:d2] == NSOrderedDescending) {
...
+ (NSArray *)sortArray:(NSArray *)array Aes:(BOOL)aes timeKey:(NSString *)timeKey {
    ...
    return [array sortedArrayUsingComparator:^NSComparisonResult(id  _Nonnull obj1, id  _Nonnull obj2) {
        NSString *date1 = [obj1 valueForKey:timeKey];
        NSString *date2 = [obj2 valueForKey:timeKey];
...
+ (NSArray *)sortedArray:(NSArray *)array aes:(BOOL)aes
{
    ...
    return [array sortedArrayUsingComparator:^NSComparisonResult(id  _Nonnull obj1, id  _Nonnull obj2) {
        NSString *date1 = [obj1 valueForKey:@"recvTime"];
        NSString *date2 = [obj2 valueForKey:@"recvTime"];
...
+ (NSArray *)sortedByLetterWithArray:(NSArray *)array keyName:(NSString *)keyName
{
    return  [array sortedArrayUsingComparator:^NSComparisonResult(id  _Nonnull obj1, id  _Nonnull obj2) {
        ...
        NSLog(@"%@", array);
        NSString *st1 = [obj1 valueForKey:keyName];
        NSString *st2 = [obj2 valueForKey:keyName];
        
        char c1 = pinyinFirstLetter([st1 characterAtIndex:0]);
        char c2 = pinyinFirstLetter([st2 characterAtIndex:0]);
        
        NSString *s1 =[NSString stringWithFormat:@"%c",c1];
        NSString *s2 = [NSString stringWithFormat:@"%c",c2];
